...
class LiveEntitySuite extends SparkFunSuite {
  ...
  test("makeNegative correctly negates all metrics with proper argument order") {
    ...
    assert(
      negatedMetrics.outputMetrics.bytesWritten === expectedNegated(13L),
      "outputMetrics.bytesWritten should be correctly negated")
    assert(
      negatedMetrics.outputMetrics.recordsWritten === expectedNegated(14L),
    ...
    assert(
      negatedMetrics.shuffleReadMetrics.remoteBlocksFetched === expectedNegated(15L),
      "shuffleReadMetrics.remoteBlocksFetched should be correctly negated")
    assert(
      negatedMetrics.shuffleReadMetrics.localBlocksFetched === expectedNegated(16L),
      "shuffleReadMetrics.localBlocksFetched should be correctly negated")
    assert(
      negatedMetrics.shuffleReadMetrics.fetchWaitTime === expectedNegated(17L),
      "shuffleReadMetrics.fetchWaitTime should be correctly negated")
    assert(
      negatedMetrics.shuffleReadMetrics.remoteBytesRead === expectedNegated(18L),
      "shuffleReadMetrics.remoteBytesRead should be correctly negated")
    assert(
      negatedMetrics.shuffleReadMetrics.remoteBytesReadToDisk === expectedNegated(19L),
      "shuffleReadMetrics.remoteBytesReadToDisk should be correctly negated")
    assert(
      negatedMetrics.shuffleReadMetrics.localBytesRead === expectedNegated(20L),
      "shuffleReadMetrics.localBytesRead should be correctly negated")
    assert(
      negatedMetrics.shuffleReadMetrics.recordsRead === expectedNegated(21L),
    ...
    assert(
      negatedMetrics.shuffleReadMetrics.shufflePushReadMetrics.corruptMergedBlockChunks ===
        expectedNegated(22L),
      "shufflePushReadMetrics.corruptMergedBlockChunks should be correctly negated")
    assert(
      negatedMetrics.shuffleReadMetrics.shufflePushReadMetrics.mergedFetchFallbackCount ===
        expectedNegated(23L),
      "shufflePushReadMetrics.mergedFetchFallbackCount should be correctly negated")
    assert(
      negatedMetrics.shuffleReadMetrics.shufflePushReadMetrics.remoteMergedBlocksFetched ===
        expectedNegated(24L),
      "shufflePushReadMetrics.remoteMergedBlocksFetched should be correctly negated")
    assert(
      negatedMetrics.shuffleReadMetrics.shufflePushReadMetrics.localMergedBlocksFetched ===
        expectedNegated(25L),
      "shufflePushReadMetrics.localMergedBlocksFetched should be correctly negated")
    assert(
      negatedMetrics.shuffleReadMetrics.shufflePushReadMetrics.remoteMergedChunksFetched ===
        expectedNegated(26L),
      "shufflePushReadMetrics.remoteMergedChunksFetched should be correctly negated")
    assert(
      negatedMetrics.shuffleReadMetrics.shufflePushReadMetrics.localMergedChunksFetched ===
        expectedNegated(27L),
      "shufflePushReadMetrics.localMergedChunksFetched should be correctly negated")
    assert(
      negatedMetrics.shuffleReadMetrics.shufflePushReadMetrics.remoteMergedBytesRead ===
        expectedNegated(28L),
      "shufflePushReadMetrics.remoteMergedBytesRead should be correctly negated")
    assert(
      negatedMetrics.shuffleReadMetrics.shufflePushReadMetrics.localMergedBytesRead ===
        expectedNegated(29L),
      "shufflePushReadMetrics.localMergedBytesRead should be correctly negated")
    assert(
      negatedMetrics.shuffleReadMetrics.remoteReqsDuration === expectedNegated(30L),
      "shuffleReadMetrics.remoteReqsDuration should be correctly negated")
    assert(
      negatedMetrics.shuffleReadMetrics.shufflePushReadMetrics.remoteMergedReqsDuration ===
        expectedNegated(31L),
    ...
    assert(
      negatedZeroMetrics.executorDeserializeTime === -1L,
      "Zero value should be converted to -1")
    assert(
      negatedZeroMetrics.inputMetrics.bytesRead === -1L,
      "Zero input metric should be converted to -1")
    assert(
      negatedZeroMetrics.outputMetrics.bytesWritten === -1L,
