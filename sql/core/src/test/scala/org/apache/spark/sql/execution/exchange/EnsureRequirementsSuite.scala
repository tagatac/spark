...
class EnsureRequirementsSuite extends SharedSparkSession {
  ...
  test("reorder should handle KeyGroupedPartitioning") {
    ...
    val plan1 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(Seq(years(exprA), bucket(4, exprB), days(exprC)), 4))
    val plan2 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(Seq(years(exprB), bucket(4, exprA), days(exprD)), 4))
    ...
    val plan3 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(Seq(bucket(4, exprD), days(exprA), years(exprC)), 4))
  ...
  test("Check with KeyGroupedPartitioning") {
    ...
    var plan1 =
      new DummySparkPlanWithBatchScanChild(KeyGroupedPartitioning(exprA :: exprB :: Nil, 5))
    var plan2 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(exprA :: exprC :: Nil, 5))
    var smjExec =
    ...
    EnsureRequirements.apply(smjExec) match {
      case SortMergeJoinExec(
            ...
            SortExec(_, _, DummySparkPlan(_, _, right: KeyGroupedPartitioning, _, _), _),
            _) =>
        assert(left.expressions === Seq(exprA, exprB))
    ...
    plan1 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(bucket(4, exprA) :: bucket(16, exprB) :: Nil, 4))
    ...
    plan1 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(bucket(4, exprA) :: years(exprB) :: Nil, 4))
    plan2 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(bucket(4, exprA) :: years(exprC) :: Nil, 4))
    smjExec =
      SortMergeJoinExec(exprA :: exprB :: Nil, exprA :: exprC :: Nil, Inner, None, plan1, plan2)
    EnsureRequirements.apply(smjExec) match {
      case SortMergeJoinExec(
    ...
    plan1 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(bucket(4, exprA) :: bucket(4, exprB) :: Nil, 4))
    plan2 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(bucket(4, exprA) :: bucket(4, exprC) :: Nil, 4))
    smjExec = SortMergeJoinExec(
      exprA :: exprB :: exprB :: Nil,
      exprA :: exprC :: exprC :: Nil,
      Inner,
  ...
  test(s"KeyGroupedPartitioning with ${REQUIRE_ALL_CLUSTER_KEYS_FOR_CO_PARTITION.key} = false") {
    var plan1 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(bucket(4, exprB) :: years(exprC) :: Nil, 4))
    var plan2 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(bucket(4, exprC) :: years(exprB) :: Nil, 4))
    ...
    plan1 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(years(exprA) :: bucket(4, exprB) :: days(exprA) :: Nil, 5))
    plan2 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(years(exprA) :: bucket(4, exprC) :: days(exprA) :: Nil, 5))
    smjExec = SortMergeJoinExec(
      exprA :: exprB :: exprB :: Nil,
      exprA :: exprC :: exprC :: Nil,
      Inner,
    ...
    plan1 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(bucket(4, exprA) :: bucket(4, exprB) :: Nil, 4))
    plan2 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(bucket(4, exprB) :: bucket(4, exprC) :: Nil, 4))
    ...
    plan1 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(bucket(4, exprA) :: bucket(4, exprB) :: Nil, 4))
    plan2 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(bucket(4, exprA) :: bucket(8, exprC) :: Nil, 4))
    smjExec = SortMergeJoinExec(
      exprA :: exprB :: exprB :: Nil,
      exprA :: exprC :: exprC :: Nil,
      Inner,
    ...
    plan1 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(years(exprA) :: bucket(4, exprB) :: Nil, 4))
    plan2 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(days(exprA) :: bucket(4, exprC) :: Nil, 4))
    smjExec = SortMergeJoinExec(
      exprA :: exprB :: exprB :: Nil,
      exprA :: exprC :: exprC :: Nil,
      Inner,
    ...
    plan1 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(years(exprA) :: buckets(4, Seq(exprB, exprC)) :: Nil, 4))
    plan2 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
      KeyGroupedPartitioning(years(exprA) :: buckets(4, Seq(exprB, exprC)) :: Nil, 4))
    smjExec = SortMergeJoinExec(
      exprA :: exprB :: exprB :: Nil,
    ...
    withSQLConf(SQLConf.V2_BUCKETING_PUSH_PART_VALUES_ENABLED.key -> "true") {
      ...
      var plan1 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
        KeyGroupedPartitioning(
          bucket(4, exprB) :: bucket(8, exprC) :: Nil,
          leftPartValues.length,
          leftPartValues))
      var plan2 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
        KeyGroupedPartitioning(
          bucket(4, exprC) :: bucket(8, exprB) :: Nil,
          rightPartValues.length,
          rightPartValues))
      ...
      applyEnsureRequirementsWithSubsetKeys(smjExec) match {
        case SortMergeJoinExec(
          ...
          assert(
            left.partitionings.head.asInstanceOf[KeyGroupedPartitioning].expressions ==
  ...
  test(
    ...
    withSQLConf(SQLConf.V2_BUCKETING_SHUFFLE_ENABLED.key -> "true") {
      ...
      val plan1 = new DummySparkPlanWithBatchScanChild(outputPartitioning =
        KeyGroupedPartitioning(identity(a1) :: Nil, 4, partitionValue))
      ...
      EnsureRequirements.apply(smjExec) match {
        case ShuffledHashJoinExec(
              ...
              ShuffleExchangeExec(
                KeyGroupedPartitioning(attrs, 4, pv, _),
