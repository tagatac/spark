...
class Analyzer(
            ...
            val newMatchedActions = m.matchedActions.map {
              ...
              case UpdateAction(updateCondition, assignments, fromStar) =>
                ...
                UpdateAction(
                  ...
                  resolveAssignments(assignments, m, MergeResolvePolicy.BOTH, throws = throws),
                  fromStar)
              case UpdateStarAction(updateCondition) =>
                ...
                UpdateAction(
                  ...
                  resolveAssignments(assignments, m, MergeResolvePolicy.SOURCE, throws = throws),
                  fromStar = true)
              case o => o
            }
            ...
            val newNotMatchedBySourceActions = m.notMatchedBySourceActions.map {
              ...
              case UpdateAction(updateCondition, assignments, fromStar) =>
                ...
                UpdateAction(
                  ...
                  resolveAssignments(assignments, m, MergeResolvePolicy.TARGET, throws = throws),
                  fromStar)
              case o => o
            }
   ...
   * potentially expensive partition/schema discovery process in some cases. In order to avoid
   * duplicate external functions lookup, the external function identifier will store in the local
   * hash set externalFunctionNameSet.
   * @see
   *   [[ResolveFunctions]]
   * @see
      ...
      case q: LogicalPlan =>
        q.transformExpressionsUpWithPruning(
          ...
          case u @ UnresolvedFunction(nameParts, arguments, _, _, _, _, _)
            ...
            withPosition(u) {
              functionResolution
                .resolveBuiltinOrTempFunction(nameParts, arguments, u)
                .map {
...
object EliminateSubqueryAliases extends Rule[LogicalPlan] {
  ...
  def apply(plan: LogicalPlan): LogicalPlan = AnalysisHelper.allowInvokingTransformsInAnalyzer {
    plan.transformUpWithPruning(AlwaysProcess.fn, ruleId) { case SubqueryAlias(_, child) =>
      child
    }
  }
}
