...
class DDLParserSuite extends AnalysisTest {
  ...
  test("create/replace table - with cluster by") {
    ...
    Seq(
      ...
      (
        ...
        "a.b, ts",
        Seq(
          ColumnDefinition("a", new StructType().add("b", IntegerType).add("c", StringType)),
          ColumnDefinition("ts", TimestampType)),
        ClusterByTransform(Seq(FieldReference(Seq("a", "b")), FieldReference("ts"))))).foreach {
      case (columns, clusteringColumns, schema, clusterByTransform) =>
        val createSql =
  ...
  test("create/replace table - mixed partition references and column definitions") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = createSql, start = 0, stop = 72))
    ...
    checkError(
      ...
      condition = "_LEGACY_ERROR_TEMP_0035",
      parameters = Map("message" -> value1),
      context = ExpectedContext(fragment = replaceSql, start = 0, stop = 73))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = createSqlWithExpr, start = 0, stop = 86))
    ...
    checkError(
      ...
      condition = "_LEGACY_ERROR_TEMP_0035",
      parameters = Map("message" -> value2),
      context = ExpectedContext(fragment = replaceSqlWithExpr, start = 0, stop = 87))
  }
  ...
  test("create/replace table - stored as format with serde") {
    Seq("sequencefile", "textfile", "rcfile").foreach { format =>
      ...
      val expectedTableSpec = TableSpec(
        ...
        Some(
          SerdeInfo(
            storedAs = Some(format),
            serde = Some("customSerde"),
            serdeProperties = Map("prop" -> "value"))))
      Seq(createSql, replaceSql).foreach { sql =>
        testCreateOrReplaceDdl(sql, expectedTableSpec, expectedIfNotExists = false)
      }
    }
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = createSql, start = 0, stop = 150))
    ...
    checkError(
      ...
      condition = "_LEGACY_ERROR_TEMP_0035",
      parameters = Map("message" -> value),
      context = ExpectedContext(fragment = replaceSql, start = 0, stop = 151))
  }
  ...
  test("create/replace table - stored as format with delimited clauses") {
    ...
    checkError(
      ...
      condition = "_LEGACY_ERROR_TEMP_0035",
      parameters = Map("message" -> value),
      context = ExpectedContext(fragment = createFailSql, start = 0, stop = 127))
    ...
    checkError(
      ...
      condition = "_LEGACY_ERROR_TEMP_0035",
      parameters = Map("message" -> value),
      context = ExpectedContext(fragment = replaceFailSql, start = 0, stop = 128))
  }
  ...
  test("create/replace table - using with stored as") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = createSql, start = 0, stop = 75))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = replaceSql, start = 0, stop = 76))
  }
  ...
  test("create/replace table - using with row format serde") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = createSql, start = 0, stop = 88))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = replaceSql, start = 0, stop = 89))
  }
  ...
  test("create/replace table - using with row format delimited") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = createSql, start = 0, stop = 103))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = replaceSql, start = 0, stop = 104))
  }
  ...
  test("create/replace table - stored by") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = fragment, start = 43, stop = 61))
    ...
    checkError(
      ...
      condition = "INVALID_STATEMENT_OR_CLAUSE",
      parameters = Map("operation" -> "STORED BY"),
      context = ExpectedContext(fragment = fragment, start = 44, stop = 62))
  }
  ...
  test("Unsupported skew clause - create/replace table") {
    ...
    checkError(
      ...
      condition = "INVALID_STATEMENT_OR_CLAUSE",
      parameters = Map("operation" -> "CREATE TABLE ... SKEWED BY"),
      context = ExpectedContext(fragment = sql2, start = 0, stop = 57))
  }
  ...
  test("Duplicate clauses - create/replace table") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql1, start = 0, stop = 99))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql2, start = 0, stop = 77))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql3, start = 0, stop = 71))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql4, start = 0, stop = 101))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql5, start = 0, stop = 73))
    ...
    checkError(
      ...
      condition = "DUPLICATE_CLAUSES",
      parameters = Map("clauseName" -> "PARTITIONED BY"),
      context = ExpectedContext(fragment = sql6, start = 0, stop = 81))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql7, start = 0, stop = 71))
    ...
    checkError(
      ...
      condition = "DUPLICATE_CLAUSES",
      parameters = Map("clauseName" -> "STORED AS/BY"),
      context = ExpectedContext(fragment = sql8, start = 0, stop = 127))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql9, start = 0, stop = 85))
    ...
    checkError(
      ...
      condition = "DUPLICATE_CLAUSES",
      parameters = Map("clauseName" -> "TBLPROPERTIES"),
      context = ExpectedContext(fragment = sql10, start = 0, stop = 100))
    ...
    checkError(
      ...
      condition = "DUPLICATE_CLAUSES",
      parameters = Map("clauseName" -> "LOCATION"),
      context = ExpectedContext(fragment = sql11, start = 0, stop = 78))
    ...
    checkError(
      ...
      condition = "DUPLICATE_CLAUSES",
      parameters = Map("clauseName" -> "COMMENT"),
      context = ExpectedContext(fragment = sql12, start = 0, stop = 72))
    ...
    checkError(
      ...
      condition = "DUPLICATE_CLAUSES",
      parameters = Map("clauseName" -> "CLUSTERED BY"),
      context = ExpectedContext(fragment = sql13, start = 0, stop = 102))
    ...
    checkError(
      ...
      condition = "DUPLICATE_CLAUSES",
      parameters = Map("clauseName" -> "PARTITIONED BY"),
      context = ExpectedContext(fragment = sql14, start = 0, stop = 74))
    ...
    checkError(
      ...
      condition = "DUPLICATE_CLAUSES",
      parameters = Map("clauseName" -> "PARTITIONED BY"),
      context = ExpectedContext(fragment = sql15, start = 0, stop = 82))
    ...
    checkError(
      ...
      condition = "DUPLICATE_CLAUSES",
      parameters = Map("clauseName" -> "STORED AS/BY"),
      context = ExpectedContext(fragment = sql16, start = 0, stop = 72))
    ...
    checkError(
      ...
      condition = "DUPLICATE_CLAUSES",
      parameters = Map("clauseName" -> "STORED AS/BY"),
      context = ExpectedContext(fragment = sql17, start = 0, stop = 128))
    ...
    checkError(
      ...
      condition = "DUPLICATE_CLAUSES",
      parameters = Map("clauseName" -> "ROW FORMAT"),
      context = ExpectedContext(fragment = sql18, start = 0, stop = 86))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql19, start = 0, stop = 65))
    ...
    checkError(
      ...
      condition = "DUPLICATE_CLAUSES",
      parameters = Map("clauseName" -> "CLUSTER BY"),
      context = ExpectedContext(fragment = sql20, start = 0, stop = 66))
  }
    ...
    Seq(createSql, replaceSql).foreach { sql =>
      testCreateOrReplaceDdl(
        ...
        TableSpec(
          ...
          Some("json"),
          OptionList(
            Seq(("a", Literal(1)), ("b", Literal(Decimal(0.1))), ("c" -> Literal(true)))),
          None,
          None,
          None),
  ...
  private def testCreateOrReplaceDdl(
    ...
    parsedPlan match {
      ...
      case other =>
        fail(
          "First token in statement does not match the expected parsed plan; CREATE TABLE" +
  ...
  test("alter table: add multiple columns") {
    comparePlans(
      ...
      AddColumns(
        ...
        Seq(
          QualifiedColType(None, "x", IntegerType, true, None, None, None),
  ...
  test("alter table: update column type invalid type") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = fragment, start = 47, stop = 54))
  }
  ...
  test("alter table: bulk alter column") {
    comparePlans(
      parsePlan("""ALTER TABLE table_name ALTER COLUMN
          | a.b.c SET NOT NULL,
  ...
  test("alter table: hive style change column") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql4, start = 0, stop = 54))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql5, start = 0, stop = 65))
  }
  ...
  test("alter table: hive style replace columns") {
    ...
    val sql4 =
      "ALTER TABLE table_name REPLACE COLUMNS (x string COMMENT 'x1', y int COMMENT 'y1')"
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql5, start = 0, stop = 66))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql6, start = 0, stop = 57))
    ...
    checkError(
      ...
      condition = "_LEGACY_ERROR_TEMP_0034",
      parameters =
        Map("operation" -> "Column position", "command" -> "REPLACE COLUMNS", "msg" -> ""),
      context = ExpectedContext(fragment = sql7, start = 0, stop = 54))
    ...
    checkError(
      ...
      parameters = Map(
        ...
        "msg" -> ""),
      context = ExpectedContext(fragment = sql8, start = 0, stop = 52))
    ...
    checkError(
      ...
      parameters = Map("type" -> "REPLACE", "columnName" -> "a", "optionName" -> "COMMENT"),
      context = ExpectedContext(fragment = sql9, start = 0, stop = 72))
  }
  ...
  test("insert table: basic append") {
    Seq(
      ...
      "INSERT INTO testcat.ns1.ns2.tbl SELECT * FROM source").foreach { sql =>
      parseCompare(
        sql,
        InsertIntoStatement(
  ...
  test("insert table: basic append with a column list") {
    Seq(
      ...
      "INSERT INTO testcat.ns1.ns2.tbl (a, b) SELECT * FROM source").foreach { sql =>
      parseCompare(
        sql,
        InsertIntoStatement(
          UnresolvedRelation(Seq("testcat", "ns1", "ns2", "tbl")),
  ...
  test("insert table: append from another catalog") {
    parseCompare(
      "INSERT INTO TABLE testcat.ns1.ns2.tbl SELECT * FROM testcat2.db.tbl",
      InsertIntoStatement(
        UnresolvedRelation(Seq("testcat", "ns1", "ns2", "tbl")),
        Map.empty,
        Nil,
  ...
  test("insert table: overwrite") {
    Seq(
      ...
      "INSERT OVERWRITE testcat.ns1.ns2.tbl SELECT * FROM source").foreach { sql =>
      parseCompare(
        sql,
        InsertIntoStatement(
          UnresolvedRelation(Seq("testcat", "ns1", "ns2", "tbl")),
  ...
  test("insert table: overwrite with column list") {
    Seq(
      ...
      "INSERT OVERWRITE testcat.ns1.ns2.tbl (a, b) SELECT * FROM source").foreach { sql =>
      parseCompare(
        sql,
        InsertIntoStatement(
          UnresolvedRelation(Seq("testcat", "ns1", "ns2", "tbl")),
  ...
  test("insert table: if not exists with dynamic partition fails") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = fragment, start = 0, stop = 78))
  }
  ...
  test("insert table: if not exists without overwrite fails") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = fragment, start = 0, stop = 69))
  }

  test("insert table: by name") {
    Seq(
      "INSERT INTO TABLE testcat.ns1.ns2.tbl BY NAME SELECT * FROM source",
      "INSERT INTO testcat.ns1.ns2.tbl BY NAME SELECT * FROM source").foreach { sql =>
      parseCompare(
        sql,
        InsertIntoStatement(
          UnresolvedRelation(Seq("testcat", "ns1", "ns2", "tbl")),
    ...
    Seq(
      ...
      "INSERT OVERWRITE testcat.ns1.ns2.tbl BY NAME SELECT * FROM source").foreach { sql =>
      parseCompare(
        sql,
        InsertIntoStatement(
          UnresolvedRelation(Seq("testcat", "ns1", "ns2", "tbl")),
  ...
  test("insert table: by name unsupported case") {
    checkError(
      exception = parseException("INSERT INTO TABLE t1 BY NAME (c1,c2) SELECT * FROM tmp_view"),
      condition = "PARSE_SYNTAX_ERROR",
      parameters = Map("error" -> "'c1'", "hint" -> ""))
  }
  ...
  test("delete from table: with alias and where clause") {
    parseCompare(
      "DELETE FROM testcat.ns1.ns2.tbl AS t WHERE t.a = 2",
      DeleteFromTable(
  ...
  test("delete from table: column aliases are not allowed") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql, start = 0, stop = 56))
  }
  ...
  test("update table: basic") {
    parseCompare(
      ...
      UpdateTable(
        UnresolvedRelation(Seq("testcat", "ns1", "ns2", "tbl")),
        Seq(
          Assignment(UnresolvedAttribute("a"), Literal("Robert")),
  ...
  test("update table: with alias and where clause") {
    parseCompare(
      ...
      UpdateTable(
        SubqueryAlias("t", UnresolvedRelation(Seq("testcat", "ns1", "ns2", "tbl"))),
        Seq(
          Assignment(UnresolvedAttribute("t.a"), Literal("Robert")),
  ...
  test("update table: column aliases are not allowed") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql, start = 0, stop = 70))
  }
    ...
    parseCompare(
      ...
      MergeIntoTable(
        ...
        Seq(
          ...
          UpdateAction(
            Some(EqualTo(UnresolvedAttribute("target.col2"), Literal("update"))),
            Seq(
              Assignment(
                UnresolvedAttribute("target.col2"),
                UnresolvedAttribute("source.col2"))))),
        Seq(
          InsertAction(
            Some(EqualTo(UnresolvedAttribute("target.col2"), Literal("insert"))),
            Seq(
              Assignment(UnresolvedAttribute("target.col1"), UnresolvedAttribute("source.col1")),
              Assignment(
                UnresolvedAttribute("target.col2"),
                UnresolvedAttribute("source.col2"))))),
        Seq(
          DeleteAction(Some(EqualTo(UnresolvedAttribute("target.col3"), Literal("delete")))),
          UpdateAction(
            Some(EqualTo(UnresolvedAttribute("target.col3"), Literal("update"))),
    ...
    parseCompare(
      ...
      MergeIntoTable(
        ...
        SubqueryAlias(
          "source",
          UnresolvedWith(
            Project(Seq(UnresolvedStar(None)), UnresolvedRelation(Seq("s"))),
            Seq(
              (
                "s",
                SubqueryAlias(
  ...
  test("merge into table: star") {
    parseCompare(
      ...
      MergeIntoTable(
        ...
        Seq(
          InsertStarAction(Some(EqualTo(UnresolvedAttribute("target.col2"), Literal("insert"))))),
        Seq.empty,
        withSchemaEvolution = false))
  }
  ...
  test("merge into table: not matched by target") {
    parseCompare(
      ...
      MergeIntoTable(
        ...
        Seq(
          InsertAction(
            Some(EqualTo(UnresolvedAttribute("target.col3"), Literal("insert1"))),
            Seq(
              Assignment(UnresolvedAttribute("target.col1"), UnresolvedAttribute("source.col1")),
              Assignment(UnresolvedAttribute("target.col2"), Literal(0)))),
          InsertAction(
            Some(EqualTo(UnresolvedAttribute("target.col3"), Literal("insert2"))),
            Seq(
              Assignment(UnresolvedAttribute("target.col1"), Literal(1)),
              Assignment(
                UnresolvedAttribute("target.col2"),
                UnresolvedAttribute("source.col2")))),
    ...
    Seq("target(c1, c2)" -> "source", "target" -> "source(c1, c2)").foreach {
      case (targetAlias, sourceAlias) =>
        ...
        checkError(
          ...
          context = ExpectedContext(fragment = sql, start = 0, stop = 365))
    }
  }
    ...
    parseCompare(
      ...
      MergeIntoTable(
        ...
        Seq(
          DeleteAction(Some(EqualTo(UnresolvedAttribute("target.col2"), Literal("delete")))),
          UpdateAction(
            Some(EqualTo(UnresolvedAttribute("target.col2"), Literal("update1"))),
            Seq(Assignment(UnresolvedAttribute("target.col2"), Literal(1)))),
          UpdateAction(
            Some(EqualTo(UnresolvedAttribute("target.col2"), Literal("update2"))),
            Seq(Assignment(UnresolvedAttribute("target.col2"), Literal(2))))),
        Seq(
          InsertAction(
            Some(EqualTo(UnresolvedAttribute("target.col2"), Literal("insert1"))),
            Seq(
              Assignment(UnresolvedAttribute("target.col1"), UnresolvedAttribute("source.col1")),
              Assignment(UnresolvedAttribute("target.col2"), Literal(1)))),
          InsertAction(
            Some(EqualTo(UnresolvedAttribute("target.col2"), Literal("insert2"))),
            Seq(
              Assignment(UnresolvedAttribute("target.col1"), UnresolvedAttribute("source.col1")),
        ...
        Seq(
          DeleteAction(Some(EqualTo(UnresolvedAttribute("target.col3"), Literal("delete")))),
          UpdateAction(
            Some(EqualTo(UnresolvedAttribute("target.col3"), Literal("update1"))),
            Seq(Assignment(UnresolvedAttribute("target.col3"), Literal(1)))),
          UpdateAction(
            Some(EqualTo(UnresolvedAttribute("target.col3"), Literal("update2"))),
  ...
  test("merge into table: only the last matched clause can omit the condition") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql, start = 0, stop = 369))
  }
  ...
  test("merge into table: only the last not matched clause can omit the condition") {
    ...
    checkError(
      ...
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql, start = 0, stop = 494))
  }

  test(
    "merge into table: only the last not matched by source clause can omit the " +
      "condition") {
    val sql =
      """MERGE INTO testcat1.ns1.ns2.tbl AS target
        |USING testcat2.ns1.ns2.tbl AS source
    ...
    checkError(
      ...
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql, start = 0, stop = 531))
  }
  ...
  test("merge into table: there must be a when (not) matched condition") {
    ...
    checkError(
      ...
      parameters = Map.empty,
      context = ExpectedContext(fragment = sql, start = 0, stop = 106))
  }

  test("show views") {
    comparePlans(parsePlan("SHOW VIEWS"), ShowViews(CurrentNamespace, None))
    comparePlans(parsePlan("SHOW VIEWS '*test*'"), ShowViews(CurrentNamespace, Some("*test*")))
    comparePlans(
  ...
  test("analyze table statistics") {
    comparePlans(
      parsePlan("analyze table a.b.c compute statistics"),
      AnalyzeTable(
        UnresolvedTableOrView(Seq("a", "b", "c"), "ANALYZE TABLE", allowTempView = false),
        Map.empty,
        noScan = false))
    comparePlans(
      parsePlan("analyze table a.b.c compute statistics noscan"),
      AnalyzeTable(
        UnresolvedTableOrView(Seq("a", "b", "c"), "ANALYZE TABLE", allowTempView = false),
        Map.empty,
        noScan = true))
    comparePlans(
      parsePlan("analyze table a.b.c partition (a) compute statistics nOscAn"),
      AnalyzeTable(
        UnresolvedTableOrView(Seq("a", "b", "c"), "ANALYZE TABLE", allowTempView = false),
        Map("a" -> None),
        noScan = true))
    ...
    comparePlans(
      ...
      AnalyzeTable(
        UnresolvedTableOrView(Seq("a", "b", "c"), "ANALYZE TABLE", allowTempView = false),
        Map("ds" -> Some("2008-04-09"), "hr" -> Some("11")),
        noScan = false))
    comparePlans(
      parsePlan(
        "ANALYZE TABLE a.b.c PARTITION(ds='2008-04-09', hr=11) COMPUTE STATISTICS noscan"),
      AnalyzeTable(
        UnresolvedTableOrView(Seq("a", "b", "c"), "ANALYZE TABLE", allowTempView = false),
        Map("ds" -> Some("2008-04-09"), "hr" -> Some("11")),
        noScan = true))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql1, start = 0, stop = 42))
    ...
    checkError(
      ...
      condition = "INVALID_SQL_SYNTAX.ANALYZE_TABLE_UNEXPECTED_NOSCAN",
      parameters = Map("ctx" -> "XXXX"),
      context = ExpectedContext(fragment = sql2, start = 0, stop = 56))
  }

  test("SPARK-33687: analyze tables statistics") {
    comparePlans(
      parsePlan("ANALYZE TABLES IN a.b.c COMPUTE STATISTICS"),
      AnalyzeTables(UnresolvedNamespace(Seq("a", "b", "c")), noScan = false))
    comparePlans(
      parsePlan("ANALYZE TABLES COMPUTE STATISTICS"),
      AnalyzeTables(CurrentNamespace, noScan = false))
    comparePlans(
      parsePlan("ANALYZE TABLES FROM a COMPUTE STATISTICS NOSCAN"),
    ...
    checkError(
      ...
      condition = "INVALID_SQL_SYNTAX.ANALYZE_TABLE_UNEXPECTED_NOSCAN",
      parameters = Map("ctx" -> "XXXX"),
      context = ExpectedContext(fragment = sql, start = 0, stop = 46))
  }
  ...
  test("CACHE TABLE") {
    comparePlans(
      ...
      CacheTable(UnresolvedRelation(Seq("a", "b", "c")), Seq("a", "b", "c"), false, Map.empty))
    ...
    comparePlans(
      ...
      CacheTable(UnresolvedRelation(Seq("a", "b", "c")), Seq("a", "b", "c"), true, Map.empty))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql, start = 0, stop = 42))
  }
  ...
  test("SPARK-46610: throw exception when no value for a key in create table options") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = createTableSql, start = 0, stop = 62))
  }
  ...
  test("alter view: add partition (not supported)") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql, start = 0, stop = 117))
  }
  ...
  test("DESCRIBE FUNCTION") {
    ...
    comparePlans(parsePlan("DESC FUNCTION a"), DescribeFunction(createFuncPlan(Seq("a")), false))
    comparePlans(
  ...
  test("REFRESH FUNCTION") {
    parseCompare("REFRESH FUNCTION c", RefreshFunction(UnresolvedIdentifier(Seq("c"))))
    parseCompare("REFRESH FUNCTION b.c", RefreshFunction(UnresolvedIdentifier(Seq("b", "c"))))
    parseCompare(
  ...
  test("CREATE INDEX") {
    parseCompare(
      ...
      CreateIndex(
        UnresolvedTable(Seq("a", "b", "c"), "CREATE INDEX"),
        "i1",
        "BTREE",
        false,
    ...
    parseCompare(
      ...
      CreateIndex(
        ...
        Seq(UnresolvedFieldName(Seq("col1")), UnresolvedFieldName(Seq("col2")))
          .zip(Seq(Map("k1" -> "v1"), Map("k2" -> "v2"))),
        Map.empty))

    parseCompare(
      "CREATE index i1 ON a.b.c" +
  ...
  private object TableSpec {
    def apply(plan: LogicalPlan): TableSpec = {
      plan match {
        ...
        case other =>
          fail(
            s"Expected to parse Create, CTAS, Replace, or RTAS plan" +
  ...
  test("SPARK-33474: Support typed literals as partition spec values") {
    def insertPartitionPlan(
        part: String,
        optimizeInsertIntoCmds: Boolean): InsertIntoStatement = {
      InsertIntoStatement(
    ...
    for (optimizeInsertIntoValues <- Seq(true, false)) {
      withSQLConf(
        ...
        parseCompare(dateTypeSql, insertPartitionPlan("2019-01-02", optimizeInsertIntoValues))
        withSQLConf(SQLConf.LEGACY_INTERVAL_ENABLED.key -> "true") {
          parseCompare(intervalTypeSql, insertPartitionPlan(interval, optimizeInsertIntoValues))
        }
        parseCompare(
          ymIntervalTypeSql,
          insertPartitionPlan("INTERVAL '1-2' YEAR TO MONTH", optimizeInsertIntoValues))
        parseCompare(
          dtIntervalTypeSql,
          insertPartitionPlan(
            "INTERVAL '1 02:03:04.128462' DAY TO SECOND",
            optimizeInsertIntoValues))
        parseCompare(timestampTypeSql, insertPartitionPlan(timestamp, optimizeInsertIntoValues))
        parseCompare(binaryTypeSql, insertPartitionPlan(binaryStr, optimizeInsertIntoValues))
      }
    }
  }
  ...
  test("SPARK-38335: Implement parser support for DEFAULT values for columns in tables") {
    ...
    comparePlans(
      parsePlan("CREATE TABLE my_tab(a INT, b STRING NOT NULL DEFAULT 'abc') USING parquet"),
      createTableResult)
    comparePlans(
      parsePlan("CREATE TABLE my_tab(a INT, b STRING DEFAULT 'abc' NOT NULL) USING parquet"),
      createTableResult)
    comparePlans(
      parsePlan(
        "REPLACE TABLE my_tab(a INT, " +
    ...
    comparePlans(
      ...
      AddColumns(
        UnresolvedTable(Seq("t1"), "ALTER TABLE ... ADD COLUMN"),
        Seq(
          QualifiedColType(
            None,
            "x",
    ...
    withSQLConf(SQLConf.ENABLE_DEFAULT_COLUMNS.key -> "false") {
      ...
      checkError(
        ...
        parameters = Map.empty,
        context = ExpectedContext(fragment = fragment, start = 27, stop = 57))
    }
    ...
    parseCompare(
      "VALUES (1, 2, DEFAULT) AS val",
      SubqueryAlias(
        "val",
        UnresolvedInlineTable(
          Seq("col1", "col2", "col3"),
          Seq(Seq(Literal(1), Literal(2), UnresolvedAttribute("DEFAULT"))))))
    parseCompare(
      ...
      InsertIntoStatement(
        ...
        query = UnresolvedInlineTable(
          Seq("col1", "col2"),
          Seq(Seq(Literal("a"), UnresolvedAttribute("DEFAULT")))),
        overwrite = false,
        ifPartitionNotExists = false))
    parseCompare(
      """
      ...
      MergeIntoTable(
        ...
        Seq(
          ...
          UpdateAction(
            Some(EqualTo(UnresolvedAttribute("target.col2"), Literal("update"))),
            Seq(Assignment(UnresolvedAttribute("target.col2"), UnresolvedAttribute("DEFAULT"))))),
        Seq(
          InsertAction(
            Some(EqualTo(UnresolvedAttribute("target.col2"), Literal("insert"))),
            Seq(
  ...
  test("SPARK-40944: Relax ordering constraint for CREATE TABLE column options") {
    ...
    checkError(
      exception = intercept[ParseException](
        parsePlan("CREATE TABLE my_tab(a INT, b STRING NOT NULL DEFAULT \"abc\" NOT NULL)")),
      condition = "CREATE_TABLE_COLUMN_DESCRIPTOR_DUPLICATE",
      parameters = Map("columnName" -> "b", "optionName" -> "NOT NULL"),
    ...
    checkError(
      ...
      condition = "CREATE_TABLE_COLUMN_DESCRIPTOR_DUPLICATE",
      parameters = Map("columnName" -> "b", "optionName" -> "DEFAULT"),
      context = ExpectedContext(
    ...
    checkError(
      ...
      condition = "CREATE_TABLE_COLUMN_DESCRIPTOR_DUPLICATE",
      parameters = Map("columnName" -> "b", "optionName" -> "COMMENT"),
      context = ExpectedContext(
  ...
  test("SPARK-41290: implement parser support for GENERATED ALWAYS AS columns in tables") {
    val columnsWithGenerationExpr = Seq(
      ColumnDefinition("a", IntegerType),
      ColumnDefinition("b", IntegerType, nullable = false, generationExpression = Some("a+1")))
    comparePlans(
      parsePlan(
    ...
    checkError(
      exception =
        parseException("CREATE TABLE my_tab(a INT, b INT GENERATED ALWAYS AS ()) USING PARQUET"),
      condition = "PARSE_SYNTAX_ERROR",
      parameters = Map("error" -> "')'", "hint" -> ""))
    // No parenthesis
    checkError(
  ...
  test(
    "SPARK-48824: implement parser support for " +
      ...
      val columnsWithIdentitySpec = Seq(
        ColumnDefinition(
          ...
          identityColumnSpec = Some(
            new IdentityColumnSpec(expectedStart, expectedStep, expectedAllowExplicitInsert))),
  ...
  test(
    "SPARK-48824: Column cannot have both a generation expression and an identity column spec") {
    checkError(
      exception = intercept[AnalysisException] {
        parsePlan(
          s"CREATE TABLE testcat.my_tab(id BIGINT GENERATED ALWAYS AS 1" +
  ...
  test("SPARK-48824: Identity column datatype must be long or integer") {
    checkError(
      ...
      context = ExpectedContext(
        fragment = "id FLOAT GENERATED ALWAYS AS IDENTITY()",
        start = 28,
        stop = 66))
  }
  ...
  test("SPARK-42681: Relax ordering constraint for ALTER TABLE ADD COLUMN options") {
    ...
    checkError(
      ...
      context = ExpectedContext(
        fragment = "b STRING FIRST COMMENT \"abc\" AFTER y",
        start = 30,
        stop = 65))
  }
  ...
  test("alter table collation") {
    testSuppCollations.foreach { collation =>
      comparePlans(
        parsePlan(s"ALTER TABLE t DEFAULT COLLATION ${collation.toLowerCase()}"),
        AlterTableCollation(
          UnresolvedTable(Seq("t"), "ALTER TABLE ... DEFAULT COLLATION"),
          collation))
    }
  }
}
