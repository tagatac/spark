...
class PlanParserSuite extends AnalysisTest {
  ...
  test("common table expressions") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = sql, start = 0, stop = 68))
  }
  ...
  test("query organization") {
    ...
    val limitWindowClauses = Seq(
      ...
      (
        " window w1 as () limit 10",
        (p: LogicalPlan) => WithWindowDefinition(ws, p, forPipeSQL = false).limit(10)))
  ...
  test("table valued function") {
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = fragment1, start = 14, stop = 29))
    ...
    checkError(
      ...
      context = ExpectedContext(fragment = fragment2, start = 14, stop = 43))
  }
