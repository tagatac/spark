...
private[spark] object IvyTestUtils {
  ...
  /**
   * Creates and initializes a new instance of IvySettings with default configurations. The method
   * processes the Ivy path argument using MavenUtils to ensure proper setup.
   *
   * @return
   *   A newly created and configured instance of IvySettings.
   */
