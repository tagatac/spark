 ...
 *   impurity statistics for current node
 * @param leftImpurityCalculator
 *   impurity statistics for left child node
 * @param rightImpurityCalculator
 *   impurity statistics for right child node
 * @param valid
 *   whether the current split satisfies minimum info gain or minimum number of instances per node
 */
...
private[spark] object ImpurityStats {
  ...
  /**
   * Return an [[org.apache.spark.mllib.tree.model.ImpurityStats]] object to denote that current
   * split doesn't satisfies minimum info gain or minimum number of instances per node.
   */
  ...
  /**
   * Return an [[org.apache.spark.mllib.tree.model.ImpurityStats]] object that only 'impurity' and
   * 'impurityCalculator' are defined.
   */
