 ...
 *
 * This acts as an official audit of cases where we excluded other classes. Please use the
 * narrowest possible exclude here. MIMA will usually tell you what exclude to use, e.g.:
 *
...
object MimaExcludes {
  ...
  lazy val v42excludes = v41excludes ++ Seq(
    ...
    ProblemFilters.exclude[MissingTypesProblem](
      "org.apache.spark.ui.ProxyRedirectHandler$ResponseWrapper"),
    ProblemFilters.exclude[DirectMissingMethodProblem](
      "org.apache.spark.ui.ProxyRedirectHandler#ResponseWrapper.sendRedirect"),
    ProblemFilters.exclude[IncompatibleMethTypeProblem](
      "org.apache.spark.ui.ProxyRedirectHandler#ResponseWrapper.this"),
    // [SPARK-55228][SQL] Implement Dataset.zipWithIndex in Scala API
    ProblemFilters.exclude[ReversedMissingMethodProblem](
      "org.apache.spark.sql.Dataset.zipWithIndex"))
  ...
  lazy val v41excludes = defaultExcludes ++ Seq(
    ...
    ProblemFilters.exclude[ReversedMissingMethodProblem](
      "org.apache.spark.ml.linalg.Vector.getSizeInBytes"),

    // CharType and VarcharType signature change (added collation parameter)
    ProblemFilters.exclude[DirectMissingMethodProblem](
      "org.apache.spark.sql.types.CharType.andThen"),
    ProblemFilters.exclude[DirectMissingMethodProblem](
      "org.apache.spark.sql.types.CharType.compose"),
    ProblemFilters.exclude[DirectMissingMethodProblem](
      "org.apache.spark.sql.types.CharType.copy"),
    ProblemFilters.exclude[DirectMissingMethodProblem](
      "org.apache.spark.sql.types.CharType.this"),
    ProblemFilters.exclude[MissingTypesProblem]("org.apache.spark.sql.types.CharType$"),
    ProblemFilters.exclude[DirectMissingMethodProblem](
      "org.apache.spark.sql.types.VarcharType.andThen"),
    ProblemFilters.exclude[DirectMissingMethodProblem](
      "org.apache.spark.sql.types.VarcharType.compose"),
    ProblemFilters.exclude[DirectMissingMethodProblem](
      "org.apache.spark.sql.types.VarcharType.copy"),
    ProblemFilters.exclude[DirectMissingMethodProblem](
      "org.apache.spark.sql.types.VarcharType.this"),
    ...
    ProblemFilters.exclude[DirectMissingMethodProblem](
      "org.apache.spark.sql.scripting.SqlScriptingExecution.withLocalVariableManager"),
    ...
    ProblemFilters.exclude[ReversedMissingMethodProblem](
      "org.apache.spark.sql.Dataset.repartitionById"),

    // [SPARK-54001][CONNECT] Replace block copying with ref-counting in ArtifactManager cloning
    ProblemFilters.exclude[DirectMissingMethodProblem](
      "org.apache.spark.sql.artifact.ArtifactManager.cachedBlockIdList"),

    // [SPARK-54323][PYTHON] Change the way to access logs to TVF instead of system view
    ProblemFilters.exclude[ReversedMissingMethodProblem](
      "org.apache.spark.sql.TableValuedFunction.python_worker_logs"))
  ...
  lazy val defaultExcludes = Seq(
    ...
    ProblemFilters.exclude[MissingFieldProblem](
      "org.apache.spark.launcher.SparkLauncher.SPARK_LOCAL_REMOTE"),
